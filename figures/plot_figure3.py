...
# Load data
fa2_df = pd.read_csv("source_data/Figure3a_atlas_selection_flow.tsv", sep="\t")
comp = pd.read_csv("source_data/Figure3a_atlas_reporting_label_composition.tsv", sep="\t")
b2_df = pd.read_csv("source_data/Figure3b_local_group_composition.tsv", sep="\t")
c2_df = pd.read_csv("source_data/Figure3c_local_public_type_ani.tsv", sep="\t")
d2_df = pd.read_csv("source_data/Figure3d_local_ani_margins.tsv", sep="\t")
...
pdf2, png2 = fs.save(fig, "Figure_3")
