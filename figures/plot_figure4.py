...
def load_fig4_data():
    ani = pd.read_csv("source_data/Figure4_source_pair_ani.tsv", sep="\t")
    s1 = pd.read_csv("source_data/Figure4_stage1_detection_summary.tsv", sep="\t").sort_values("minor_percent")
    c10 = pd.read_csv("source_data/Figure4_complete_10_percent_conditions.tsv", sep="\t")
    ...
    c40 = pd.read_csv("source_data/Figure4_complete_40_conditions.tsv", sep="\t")
